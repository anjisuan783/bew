...
#define MAX_SEND_BITRATE (800 * 1000)
#define MIN_SEND_BITRATE (100 * 1000)
#define START_SEND_BITRATE (300 * 1000)
...
int main(int argc, const char* argv[])
{
	...
	if (sim_connect(1000, "172.16.6.132", 16001, gcc_transport, 0, 0) != 0){
