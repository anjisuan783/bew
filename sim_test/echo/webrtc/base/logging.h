...
class LogSink {
 public:
  ...
  virtual void OnLogMessageEx(const std::string& msg,
...
// TODO: Add external flag for check
#define LOG_FLAG(sev, flag) \
  LOG_SEVERITY_PRECONDITION(rtc::sev) \
    rtc::LogMessage(__FILE__, __LINE__, rtc::sev, flag).stream()

#define LOG_FLAG_T(sev, flag) LOG_FLAG(sev, flag) << this << ": "
